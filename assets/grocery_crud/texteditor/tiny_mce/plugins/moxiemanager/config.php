...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/assets/uploads/editor";  ///webroot/uploads';
...
$moxieManagerConfig['edit.extensions'] = 'jpg,jpeg,png,gif,html,htm,txt,zip,rar';
...
$moxieManagerConfig['basicauthenticator.users'] = array(
   array(
      "username" => "adminasasasasasdasdasd",
      "password" => "passwordsasdasdasdasd",
...
$moxieManagerConfig['ExternalAuthenticator.secret_key'] = 'A000BC77RUBB';
