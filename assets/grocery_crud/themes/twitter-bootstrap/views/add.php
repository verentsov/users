  ...
  <div class="span12">
    <div class="twitter-bootstrap crud-form">
      ...
      <div id="main-table-box span12">
        <?php
        echo form_open($insert_url, 'method="post" id="crudForm" class="form-div span12  span12 form-horizontal" autocomplete="off" enctype="multipart/form-data"');
        ?>
        <legend><?php echo $this->l('form_add'); ?> <?php echo $subject ?></legend>
        ...
        <input type="button" value="<?php echo $this->l('form_save'); ?>"  class="btn   btn-inverse  submit-form"/>
        <?php
        if (!$this->unset_back_to_list)
        {
          ?>
          <input type="button" value="<?php echo $this->l('form_save_and_go_back'); ?>" id="save-and-go-back-button"  class="btn    btn-inverse "/>
          <input type="button" value="<?php echo $this->l('form_cancel'); ?>" class="btn  btn-inverse  return-to-list" />
        <?php } ?>
