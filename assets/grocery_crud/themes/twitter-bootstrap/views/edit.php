...
<div class="row-fluid" style=" margin-top:20px">
  <div class="span12">
    <div class="twitter-bootstrap crud-form">
      ...
      <div id="main-table-box" class="span12">
        <?php
        echo form_open($update_url, 'method="post" id="crudForm" class="form-div span12 form-horizontal" autocomplete="off" enctype="multipart/form-data"');
        ?>
        
        <legend><?php echo $this->l('form_edit'); ?> <?php echo $subject ?></legend>
        ...
        <table class="table   table-bordered  table-striped  table-condensed">
          ...
          foreach ($fields as $field)
          {
            ...
            <!--  <div class="form-field-box control-group" id="<?php echo $field->field_name; ?>_field_box">-->
              <td style=" width: 200px">
                <div style="font-size: 13px; padding-left: 20px; color: #000" class="form-display-as-box"  id="<?php echo $field->field_name; ?>_display_as_box">
        ...
        <input type="button" value="<?php echo $this->l('form_update_changes'); ?>" class="btn btn-inverse submit-form"/>
        <?php
        if (!$this->unset_back_to_list)
        {
          ?>
          <input type="button" value="<?php echo $this->l('form_update_and_go_back'); ?>" id="save-and-go-back-button" class="btn  btn-inverse "/>
