...
<div class="twitter-bootstrap">
  <div id="main-table-box">
    ...
    <div id="options-content" class="span12" style=" margin-top:20px; margin-bottom: 10px; font-size: 13px">
      <?php
      if (!$unset_add || !$unset_export || !$unset_print)
      {
        ...
        if (!$unset_add)
        {
          ...
          <a href="<?php echo $add_url ?>" title="<?php echo $this->l('list_add'); ?> <?php echo $subject ?>" class="add-anchor btn">
            <i class="icon-plus"></i>
            <?php echo $this->l('list_add'); ?> <b><?php echo $subject ?></b>
          </a>
          <?php
        }
        if ($unset_export = FALSE)
        {
          ?>
    ...
    <div class="pGroup span12" style=" text-align: center">
...
<div class="modal hide" id="filtering-form-search">
  <div class="modal-header">
    ...
    <h3 style=" color: #000; font-weight: normal; font-size: 18px"><?php echo $this->l('list_search') . ' ' . $subject; ?></h3>
  </div>
      ...
      <div class="span10">
        <div id="modalTab">
          <div class="tab-content">
            <?php echo form_open($ajax_list_url, 'method="post" id="filtering_form" class="form-horizontal" autocomplete = "off"'); ?>

            <div class="sDiv" id="quickSearchBox" style=" color: #000 !important; font-size: 13px !important">
              ...
              <input type="hidden" name="order_by[0]" id="hidden-sorting" value="<?php
              if (!empty($order_by[0]))
              {
                ?><?php echo $order_by[0] ?><?php } ?>" />
              <input type="hidden" name="order_by[1]" id="hidden-ordering"  value="<?php
              if (!empty($order_by[1]))
              {
              ...
              <div class="control-group" >
                <label class="control-label" for="inputEmail" style=" color: #000 !important; font-size: 13px !important"> <?php echo $this->l('list_search'); ?>:</label>
                <div class="controls">
              ...
              <div class="control-group">
                <label class="control-label" for="inputEmail" style=" color: #000 !important; font-size: 13px !important"> Где искать:</label>
                <div class="controls">
                  <select name="search_field" id="search_field" style=" color: #000 !important; font-size: 13px !important">
              ...
              <input type="button" class="btn  btn-success" data-dismiss="modal" value="<?php echo $this->l('list_search'); ?>" id="crud_search">
