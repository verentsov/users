...
if(!empty($list)){ ?>
<div class="span12" >
	<table class="table table-bordered tablesorter table-striped  table-condensed  table-hover">
		<thead>
			<tr>
		...
		<tbody>
			...
			<tr class="<?php echo ($num_row % 2 == 1) ? 'erow' : ''; ?>">
				...
				<td align="left">
					<div class="tools" >
						<div class="btn-group" > 
							<button class="btn"  style=" font-size: 13px"><?php echo $this->l('list_actions'); ?></button>
